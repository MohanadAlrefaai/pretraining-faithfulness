...
def main():
    ...
    if data_args.dataset_name is not None and not data_args.load_from_disk:
        # Downloading and loading a dataset from the hub.
        raw_datasets = load_dataset(
            data_args.dataset_name,
            data_args.dataset_config_name,
            cache_dir=model_args.cache_dir,
            data_dir=data_args.dataset_dir if data_args.dataset_dir else None,
            use_auth_token=True if model_args.use_auth_token else None,
        )
    elif not data_args.load_from_disk:
        data_files = {}
        ...
        #raw_datasets = mlm_dataset.train_test_split(test_size=0.005)
        #raw_datasets["validation"] = raw_datasets["test"]

        #raw_datasets = DatasetDict({ "train": mlm_dataset })
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples[text_column])):
            ...
            inputs.append(
                ...
                # " ".join([MLM_CONNECTOR, examples[text_column][i]])
            )
